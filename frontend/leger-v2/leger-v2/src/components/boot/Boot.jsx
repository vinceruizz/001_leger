  ...
  return (
    <div className={`boot ${phase >= 4 ? "boot--fade-out" : ""}`}>
      <div className="boot__content">
        <pre
          className={`boot__helmet ${phase >= 1 ? "boot__helmet--visible" : ""}`}
        >
          {SWORD_SHIELD}
        </pre>
        <h1
          className={`boot__title ${phase >= 2 ? "boot__title--visible" : ""}`}
        >
          Vince Ruiz Portfolio
        </h1>
        <div
          className={`boot__loader ${phase >= 3 ? "boot__loader--visible" : ""}`}
        >
          <span></span>
          <span></span>
          <span></span>
